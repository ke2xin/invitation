...
<head>
    <meta charset="UTF-8">
    <title> 祝你生日快乐！- 何问起</title>
    <meta name="viewport" content="width=device-width, initial-scale=0.8">
    <link rel="stylesheet" href="css/style.css" media="screen" type="text/css" />
    <meta name="description" content="html5动画电子生日贺卡特效 " />
...
<div>
    ...
    <p id="message">Happy Birthday To You!</p>
    <p id="message"><a href="http://hovertree.com" target="_blank">何问起</a>祝你：生日快乐！</p>
    <p id="hovertreemessage">按住向上滑动点亮蜡烛</p>
</div>
...
<script src="js/hovertreebirthday.js"></script>
<script src="js/jquery-1.8.3.min.js"></script>
<script src="js/hovertreeplay.js"></script>

<div style="text-align:center;margin:0px; font:normal 14px/24px 'MicroSoft YaHei';color:#ffffff">
